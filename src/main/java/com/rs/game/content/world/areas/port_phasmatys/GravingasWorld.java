...
import com.rs.game.content.world.npcs.LivingRock;
...
public class GravingasWorld extends NPC {
	...
	public static NPCInstanceHandler toFunc = new NPCInstanceHandler(new Object[] {npcId}, (npcId, tile) -> new GravingasWorld(npcId, tile));
}
